...
'HVAC':      {'FType':        'HVAC',
              'FDescription': 'HVAC state data file',
              'FDimNames':    ['time'],
              'FDimSize':     [len(ArrayData[:,1])],
              'Transpose':    [False]*23,
              'VarName':      ['time','EvapTemp','CondenseTemp','SetPoint','SetPointDiff','SetPointAux','SetPointAuxDiff',
                               'SetPointMin','SetPointMax','MinTempAlarmSetPoint','MaxTempAlarmSetPoint','ProbeDisp',
                               'FirmwareVersion','EvaporatorAlarm','CondenseAlarm','LowTempAlarm','HighTempAlarm',
                               'CondLowTempAlarm','CondHighTempAlarm','AuxRelayStatus','LowPressAlarm','ControlPadLock','CompressRelayStatus'],
              'VarCol':       [i for i in range(0,23)],
              'VarDim':       [('time')]*23,
              'VarType':      ['float','float32','float32','float32','float32','float32','float32','float32','float32',
                               'float32','float32','float32','float32','b','b','b','b','b','b','b','b','b','b'],
              'VarUnit':      ['Fractional Hours','Farenheit','Fahrenheit','Fahrenheit','Fahrenheit','Fahrenheit','Fahrenheit',
                               'Fahrenheit','Fahrenheit','Fahrenheit','Fahrenheit','Unitless','Unitless','Unitless','Unitless',
                               'Unitless','Unitless','Unitless','Unitless','Unitless','Unitless','Unitless','Unitless'],
              'VarDescrip':   ['The time of collected data in UTC hours from the start of the day',
                               'Temperature of the HVAC evaporator',
                               'Temperature of the HVAC condensor',
                               'Set point of the HVAC system',
                               'Set point difference required between heating and cooling',
                               'Auxillary set point',
                               'No clue...need to look',
                               'Minimum allowable set point',
                               'Maximum allowable set point',
                               'Minimum temperature alarm set point',
                               'Maximum temperature alarm set point',
                               'Probe temperature displayed on controller (0:Evaporator, 1:Condensor, 2:Not Defined',
                               'Firmware version of controller. Negative values are communication errors codes.',
                               'Status of the evaporator alarm (0: Nominal, 1:Alarm)',
                               'Status of the condensor alarm (0:Nominal, 1:Alarm)',
                               'Status of the low temperature alarm for the system (0:Nominal, 1:Alarm)',
                               'Status of the high temperature alarm for the system (0:Nominal, 1:Alarm)',
                               'Status of the low temperature alarm for the condensor (0:Nominal, 1:Alarm)',
                               'Status of the high temperature alarm for the condensor (0:Nominal, 1:Alarm)',
                               'Status of the auxillary relay (0: Open, 1: Closed)',
                               'Status of the low pressure alarm (0:Nominal, 1:Alarm)',
                               'Status of the keypad lock (0:Unlocked, 1:Locked)',
                               'Status of the compressor relay (0: Open, 1: Closed)']},
'LL':        {'FType':        'LL',
