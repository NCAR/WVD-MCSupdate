    ...
    if len(sys.argv) > 1:# check that enough arguments were passed
        ...
        if os.path.isdir(sys.argv[1]+"\\Data\\"): # the first should be the directory where the Data folder is located.
            ...
            if os.path.isdir(sys.argv[2]):
                ...
                NetCDFOtuputPath = sys.argv[1]+"\\NetCDFOutput\\"
                    ...
                    if os.path.isdir(LLDataPath):
                        ...
                        for file in LLFileList: 
                            ...
                            with open(file) as f:
                                ...
                                ensure_dir(NetCDFOtuputPath+file[-19:-11]+"\\")
                                LLncfile = Dataset(NetCDFOtuputPath+file[-19:-11]+"\\LLsample"+file[-10:-4]+".nc",'w')
                        ...
                        for file in EtalonFileList: 
                            ...
                            with open(file) as f:
                                ...
                                ensure_dir(NetCDFOtuputPath+file[-19:-11]+"\\")
                                Etalonncfile = Dataset(NetCDFOtuputPath+file[-19:-11]+"\\Etalonsample"+file[-10:-4]+".nc",'w')
                    ...
                    if os.path.isdir(MCSDataPath):
                        ...
                        for MCSfile in MCSFileList:
                            ...
                            with open(MCSfile , 'rb') as file:
                                ...
                                ensure_dir(NetCDFOtuputPath+MCSfile[-19:-11]+"\\")
                                MCSncfile = Dataset(NetCDFOtuputPath+MCSfile[-19:-11]+"\\MCSsample"+MCSfile[-10:-4]+".nc",'w')
                        ...
                        for Powerfile in MCSPowerList:
                            ...
                            with open(Powerfile, "rb") as file:
                                ...
                                ensure_dir(NetCDFOtuputPath+Powerfile[-19:-11]+"\\")
                                Powncfile = Dataset(NetCDFOtuputPath+Powerfile[-19:-11]+"\\Powsample"+Powerfile[-10:-4]+".nc",'w')
                    ...
                    if os.path.isdir(WSDataPath):
                        ...
                        for file in WSFileList: # read in file, process into NetCDF, and write out file
                            ...
                            with open(file) as f:
                                ...
                                ensure_dir(NetCDFOtuputPath+file[-19:-11]+"\\")
                                WSncfile = Dataset(NetCDFOtuputPath+file[-19:-11]+"\\WSsample"+file[-10:-4]+".nc",'w')
                ...
                ensure_dir(ErrorFile)
                fh = open(ErrorFile, "a")
                write("ERROR: argument 2 - ",sys.argv[2]," - is not a dir to write to - ",NowTime)
                fh.close
